...
/*
The components of a SRAM cache addrss:
Note: SRAM cache address is translated physical address
...
/*--------------------------------------------------*/
// place the function here because the requires the core_t type
...
// // program conter or instruction pointer
// typedef union {
//     uint64_t rip;
//     uint32_t eip;
// }cpu_pc_t;
